...
public class SwaggerConfig {
    ...
    public Docket productApi() {
       return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.stackroute.userservice.controller")).paths(PathSelectors.any()).build().apiInfo(apiInfo());
    }
